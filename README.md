# Algorithm Tests [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT) [![Hits](https://hits.seeyoufarm.com/api/count/incr/badge.svg?url=https%3A%2F%2Fgithub.com%2Fzcemycl%2FalgoTest&count_bg=%2379C83D&title_bg=%23555555&icon=&icon_color=%23E7E7E7&title=hits&edge_flat=false)](https://hits.seeyoufarm.com)
...
|17|Letter Combinations of a Phone Number|||[:shipit:](py/solns/letterCombinationsOfPhoneNo/letterCombinationsOfPhoneNo.py)|DFS|
...
|31|Next Permutation|||[:shipit:](py/solns/nextPermutation/nextPermutation.py)|Pointers|
...
|34|Find First and Last Position of Element in Sorted Array|||[:shipit:](py/solns/find1stAndLastPositionOfElementInSortedArr/find1stAndLastPositionOfElementInSortedArr.py)|Array, Binary Search|
...
|40|Combination Sum II|||[:shipit:](py/solns/combinationSum2/combinationSum2.py)|DFS|
...
|101|Symmetric Tree|||[:shipit:](py/solns/symmetricTree/symmetricTree.py)|Binary Tree|
...
|103|Binary Tree Zigzag Level Order Traversal|||[:shipit:](py/solns/btZigzagLevelOrderTraversal/btZigzagLevelOrderTraversal.py)|Binary Tree, DFS|
...
|148|Sort List|||[:shipit:](py/solns/sortList/sortList.py)|Linked List, Divide and Conquer|
...
|216|Combination Sum III|||[:shipit:](py/solns/combinationSum3/combinationSum3.py)|DFS|
...
|423|Reconstruct Original Digits from English|||[:shipit:](py/solns/reconstructDigitsFromEng/reconstructDigitsFromEng.py)|DFS|
...
|509|Fibonacci Number|||[:shipit:](py/solns/fibonacciNum/fibonacciNum.py)|Dynamic Programming|
|538|Convert BST to Greater Tree|||[:shipit:](py/solns/convertBST2GreaterTree/convertBST2GreaterTree.py) [:heavy_check_mark:](py/tests/testConvertBST2GreaterTree/test_ConvertBST2GreaterTree.py)|BST, DFS, Recursive|
...
|973|K Closest Points to Origin|||[:shipit:](py/solns/kClosestPts2Origin/kClosestPts2Origin.py)|Heap, Sorting|
|980|Unique Paths III|||[:shipit:](py/solns/uniquePaths3/uniquePaths3.py)|Graph, DFS, Backtracking|
...
|1023|Camelcase Matching|||[:shipit:](py/solns/camelcaseMatch/camelcaseMatch.py)|String|
...
|1091|Shortest Path in Binary Matrix|||[:shipit:](py/solns/shortestPathInBinaryMat/shortestPathInBinaryMat.py)|Graph, Backtracking, BFS|
...
|1143*|Longest Common Subsequence|||[:shipit:](py/solns/longestCommonSubseq/longestCommonSubseq.py) [:heavy_check_mark:](py/tests/testLongestCommonSubseq/test_LongestCommonSubseq.py)|Backtracking, Recursive, Dynamic Programming|
|1146|Snapshot Array|||[:shipit:](py/solns/snapshotArr/snapshotArr.py)|Hashmap|
|1277|Count Square Submatrices with All Ones|||[:shipit:](py/solns/countSqSubmatricesWithAll1s/countSqSubmatricesWithAll1s.py)|Matrix, Dynamic Programming|
|1288|Remove Covered Intervals|||[:shipit:](py/solns/rmCoveredIntervals/rmCoveredIntervals.py)|Interval|
...
|1293|Shortest Path in a Grid with Obstacles Elimination|||[:shipit:](py/solns/shortestPathInGridWithObstaclesElimination/shortestPathInGridWithObstaclesElimination.py)|Dynamic Programming, DFS, Graph|
...
|1518|Water Bottles|||[:shipit:](py/solns/waterBottles/waterBottles.py)||
|1592|Rearrange Spaces Between Words|||[:shipit:](py/solns/rearrangeSpacesBetweenWords/rearrangeSpacesBetweenWords.py)|String|
|1609|Even Odd Tree|||[:shipit:](py/solns/evenOddTree/evenOddTree.py)|Binary Tree|
...
|Is This a Binary Search Tree?|[:shipit:](py/solns/isBST/isBST.py) [:heavy_check_mark:](py/tests/testIsBST/test_IsBST.py)|Python|Binary Search Tree|
|Huffman Decoding|[:shipit:](py/solns/huffmanDecoding/huffmanDecoding.py) [:heavy_check_mark:](py/tests/testHuffmanDecoding/test_HuffmanDecoding.py)|Python|Binary Tree|
